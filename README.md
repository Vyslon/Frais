...
2. [Utiliser l'application sur une machine de développement](#2-utiliser-lapplication-sur-une-machine-de-d%C3%A9veloppement)  
  ...
  2.2. [Création et activation de l'environnement Python virtuel](#22-cr%C3%A9ation-et-r%C3%A9cup%C3%A9ration-de-lenvironnement-python-virtuel)  
  ...
  2.5. [Chargement du jeu de données initial dans la base de données](#25-chargement-du-jeu-de-donn%C3%A9es-initial-dans-la-base-de-donnes)  
